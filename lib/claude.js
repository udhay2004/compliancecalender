...
Your job:
1. For every generic item whose due_date_rule depends on fiscal year end, compute the ACTUAL date for THIS company's fiscal year, and show your work in the description (name the general rule AND the resulting specific date).
