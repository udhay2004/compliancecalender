...
const { sendEmail: sendEmailBase } = require("./mailer");
...
function sendEmail(args) {
  return sendEmailBase({ ...args, logPrefix: "[reminders]" });
}
...
async function runReminderSweep() {
  // Only the CURRENT calendar per company — a regenerated calendar keeps its
  // old version in history, and that must not trigger duplicate reminders.
