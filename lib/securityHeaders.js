...
// Cloudflare Turnstile "verify you are human" box on the free generator (lib/abuseGuard.js).
...
const DIRECTIVES = {
  ...
  "script-src": ["'self'", "'unsafe-inline'", "https://checkout.razorpay.com", TURNSTILE],
  ...
  "connect-src": ["'self'", RAZORPAY, TURNSTILE],
  "frame-src": [RAZORPAY, TURNSTILE],
